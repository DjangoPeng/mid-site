...
tf.app.flags.DEFINE_string("data_dir", "/home/dl/PJT/data", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "/home/dl/PJT/train_logs", "Training directory.")
...
tf.app.flags.DEFINE_integer("save_summaryies_secs", 60, 
                           "Save summaries interval seconds.")
tf.app.flags.DEFINE_integer("max_step", 1000, "Max step.")
tf.app.flags.DEFINE_string("job_name","","")
tf.app.flags.DEFINE_integer("task_index","","")
tf.app.flags.DEFINE_integer("num_workers", 3, "")
tf.app.flags.DEFINE_boolean("sync_replicas", True, "")
...
def read_data(source_path, target_path, max_size=None):
  ...
  Returns:
    data_set: a list of length len(_buckets); data_set[n] contains a list of
      ...
      into the n-th bucket, i.e., such that 2len(source) < _buckets[n][0] and
